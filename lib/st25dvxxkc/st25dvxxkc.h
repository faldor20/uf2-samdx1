...
int32_t ST25DVxxKC_ReadMailboxRegister(const ST25DVxxKC_Object_t *const pObj, uint8_t *const pData, const uint16_t offset, \
                                                          const uint16_t NbByte);
int32_t ST25DVxxKC_WriteMailboxRegister(const ST25DVxxKC_Object_t *const pObj, const uint8_t *const pData, \
                                                          const uint16_t offset, const uint16_t NbByte);
